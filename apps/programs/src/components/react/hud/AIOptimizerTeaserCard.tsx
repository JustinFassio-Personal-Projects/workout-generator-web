...
const AIOptimizerTeaserCard: React.FC<AIOptimizerTeaserCardProps> = ({
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-[#ffbf00]/10 p-6 backdrop-blur-sm">
      ...
      {isPaid ? (
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none select-none blur-md" aria-hidden>
            <div className="mb-2 flex items-center gap-2 text-[#ffbf00]/80">
          ...
          <div
            className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-t from-[#0d0500]/90 via-[#0d0500]/40 to-transparent"
            aria-hidden
          />
          {/* CTA overlay */}
          <div className="relative mt-4 flex flex-col items-center gap-3">
            <motion.button
              ...
              className="w-full rounded-2xl border border-[#ffbf00]/30 bg-[#ffbf00] py-4 font-heading text-sm font-black uppercase tracking-[0.3em] text-black shadow-[0_20px_40px_rgba(255,191,0,0.15)] transition-colors hover:border-[#ff8000] hover:bg-[#ff8000]"
            >
              Unlock AI Optimizer
            </motion.button>
