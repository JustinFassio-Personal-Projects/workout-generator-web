...
import { Plus, Trash2, X, Edit2, RotateCcw } from 'lucide-react';
...
import type { EquipmentItem, Zone } from '@/lib/supabase/client/equipment';
...
const ManageZones: React.FC = () => {
  ...
  const [equipmentFormData, setEquipmentFormData] = useState({
    name: '',
    category: 'resistance' as 'resistance' | 'cardio' | 'utility',
  });
  ...
  const handleCreateEquipment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setEquipmentFormData({ name: '', category: 'resistance' });
      ...
      {activeTab === 'inventory' && (
        <div className="space-y-6">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEquipmentFormData({
                        ...equipmentFormData,
                        category: e.target.value as 'resistance' | 'cardio' | 'utility',
                      })
                    }
          ...
          {Object.keys(equipmentByCategory).length === 0 ? (
            ...
            <div className="space-y-6">
              {(['resistance', 'cardio', 'utility'] as const).map((category) => {
