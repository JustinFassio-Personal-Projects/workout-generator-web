    ...
    <div className="relative flex flex-col items-center justify-center w-full max-w-4xl mx-auto min-h-[350px] md:min-h-[500px] overflow-hidden rounded-3xl bg-brand-dark/40 border border-white/10 shadow-2xl backdrop-blur-md">
      ...
      <div className="relative z-20 mb-10 md:mb-16 scale-[0.65] md:scale-125 mt-4 md:mt-10">
        ...
        <div className="absolute top-1/2 left-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          <FlyingItem content={Target} type="icon" delay={0} position={1} />
          <FlyingItem content="STRENGTH" type="text" delay={0.2} position={2} />
          <FlyingItem content={Activity} type="icon" delay={0.5} position={3} />
          <FlyingItem content="CARDIO" type="text" delay={0.7} position={4} />
          <FlyingItem content={Heart} type="icon" delay={1.0} position={5} />
          <FlyingItem content="RECOVERY" type="text" delay={1.2} position={6} />
          <FlyingItem content={TrendingUp} type="icon" delay={1.5} position={7} />
          <FlyingItem content="PROGRESS" type="text" delay={1.7} position={8} />
          <FlyingItem content={Zap} type="icon" delay={2.0} position={9} />
          <FlyingItem content={Award} type="icon" delay={2.2} position={10} />
        </div>
      </div>
