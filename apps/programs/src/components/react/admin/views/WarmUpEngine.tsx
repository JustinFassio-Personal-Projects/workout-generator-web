    ...
    >
      ...
      <div className="min-w-0 flex-1 space-y-2">
        ...
        <input
          ...
          className="w-full rounded border border-white/10 bg-transparent px-2 py-1.5 text-sm text-white placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none"
        ...
        <input
          ...
          className="w-full rounded border border-white/10 bg-transparent px-2 py-1.5 text-sm text-white/80 placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none"
        ...
        <input
          ...
          className="w-full rounded border border-white/10 bg-transparent px-2 py-1 text-xs text-white/80 placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none"
        ...
        <textarea
          ...
          rows={2}
          className="w-full resize-none rounded border border-white/10 bg-transparent px-2 py-1 text-xs text-white/80 placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none"
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative flex max-h-[85vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0d0500] shadow-xl"
        >
