            ...
            {onExerciseQueryChange != null && (
              <div className="min-w-0 flex-1">
                ...
                <input
                  ...
                  className="w-full min-w-0 rounded border-b border-transparent border-white/10 bg-transparent px-2 py-0.5 text-sm text-white/80 focus:border-[#ffbf00]/50 focus:bg-black/20 focus:outline-none"
                />
              </div>
            )}
            {onLink != null && (
