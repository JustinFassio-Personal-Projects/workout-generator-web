              ...
              >
                <div className="min-w-[80px] flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded border border-white/10 bg-black/30 px-2 py-1.5 text-sm text-white focus:border-[#ffbf00]/50 focus:outline-none"
                  />
                </div>
                <div className="min-w-[120px] flex-[2]">
                  ...
                  <input
                    ...
                    className="w-full rounded border border-white/10 bg-black/30 px-2 py-1.5 text-sm text-white placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none"
