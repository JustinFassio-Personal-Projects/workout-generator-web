...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoUrl }) => {
  ...
  return (
    <div className="group/video relative aspect-video w-full shrink-0 overflow-hidden rounded-2xl border border-orange-light/30 bg-black shadow-2xl">
      <div className="absolute left-4 top-4 z-20 flex items-center gap-2 rounded border border-orange-light/20 bg-black/60 px-3 py-1 backdrop-blur-md">
