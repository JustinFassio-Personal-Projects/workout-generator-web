...
interface BlogPostContentInteractiveServerProps {
  post: BlogPost
}

export const BlogPostContentInteractiveServer: React.FC<BlogPostContentInteractiveServerProps> = ({
  post,
}) => {
  return (
    <article className={styles.interactivePost}>
      {/* Navigation - Client component for scroll handlers */}
      <InteractiveNav />

      {/* Hero Section - Client component for image and buttons */}
