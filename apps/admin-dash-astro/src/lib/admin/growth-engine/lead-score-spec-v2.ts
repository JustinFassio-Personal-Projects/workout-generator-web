export const LEAD_SCORE_VERSION_V2 = 'lead-score-v2';
...
/** v2: `growth_state` uses reverse-trial + `premium_subscriber` vocabulary (see `GrowthState`). */
export const LEAD_SCORE_SPEC_V2: LeadScoreSpec = {
  version: LEAD_SCORE_VERSION_V2,
  minScore: 1,
  maxScore: 100,
  weights: [
    {
