> **Provenance:** Copied from `apps/programs/docs/features/workouts/generate-workout-modal-and-prompt.md` for the Workout Factory migration. Describes the Generate Workout modal and the 4-step AI prompt chain only.
