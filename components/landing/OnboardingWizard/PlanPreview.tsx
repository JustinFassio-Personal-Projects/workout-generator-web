  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8">
      <div className="text-center mb-2">
        <h3 className="text-2xl md:text-3xl font-display font-bold text-slate-900 dark:text-white mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        {/* Goals */}
        <div className="group relative flex flex-col p-5 bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-white/5 rounded-xl hover:border-brand-green/30 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-md">
          ...
          <div className="flex items-start gap-4 relative z-10">
            <div className="p-2 bg-brand-green/10 dark:bg-brand-green/20 rounded-lg text-brand-green shrink-0 shadow-sm">
            ...
            <div className="flex flex-col gap-1 flex-1 min-w-0">
              ...
              <span className="text-base font-bold text-slate-900 dark:text-white line-clamp-2">
                {goalsDisplay}
              </span>
            </div>
          </div>
