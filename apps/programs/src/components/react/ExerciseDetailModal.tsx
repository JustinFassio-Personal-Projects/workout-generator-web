        ...
        >
          ...
          >
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-y-auto p-8 md:p-12">
              ...
              {exercise.instructionsStructured?.steps &&
              exercise.instructionsStructured.steps.length > 0 ? (
                  ...
                  {exercise.instructionsStructured.intro && (
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: formatParagraphContent(exercise.instructionsStructured.intro),
                      }}
                    />
                  )}
                  {exercise.instructionsStructured.sectionTitle && (
                    <h4 className="text-orange-light/80 font-mono text-[10px] uppercase tracking-[0.4em]">
                      {exercise.instructionsStructured.sectionTitle}
                    </h4>
                  )}
